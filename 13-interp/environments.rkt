...
(provide make-env)  ; : ListOf<Name> ListOf<Value> Environment -> Environment
...
;; -- empty      Interp: the environment that is undefined for any name.
...
;; make-env : ListOf<Name> ListOf<Value> Environment-> Environment
...
;; STRATEGY: HOFC (using 2-argument map)
